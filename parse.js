...
async function parseCdntvmedia() {
  // Прямой адрес плеера cdntvmedia для канала Мосфильм
  ...
  try {
    ...
    if (decodeMatch) {
      ...
      // Альтернативный поиск прямой .m3u8 ссылки
    ...
    // 2. Запрос с redirect: 'manual' для перехвата редиректа/токена (как на скриншоте DevTools)
